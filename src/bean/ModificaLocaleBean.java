...
public class ModificaLocaleBean {
	...
	public ModificaLocaleBean() {
		
	}
	
	
	public ModificaLocaleBean(String indirizzo, String citta, String provincia, int mQ, int nBagni, int persone, int prezzo,
	...
	public boolean convalidaModifica(String IDlocale) {
		
		ModificaLocaleController mlc = ModificaLocaleController.getInstance();
		
		return mlc.modificaLocale(Integer.parseInt(IDlocale), nBagni, persone, prezzo, animali,
