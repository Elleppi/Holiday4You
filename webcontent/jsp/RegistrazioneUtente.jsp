...
if (request.getParameter("registra") != null) {
	...
	if(formValido == 1) {
		...
		if(e == 0) {
			if(request.getParameter("ruolo").equals("locatario"))
				RegistrazioneBean.setRuolo("Locatario");
			else
				RegistrazioneBean.setRuolo("Locatore");
			%>
			<jsp:forward page="Avviso.jsp">
			<jsp:param name="avviso" value="5"/>
			</jsp:forward>
			<%
		}
	}
		...
		<form method="POST" onsubmit= "return validateForm()">
			<fieldset>
				...
				<table>
					...
					<tr>
						<td>
							Locatore <input type="radio" name="ruolo" value="locatore" checked>
							Locatario <input type="radio" name="ruolo" value="locatario">
						</td>
						<td>
						</td>
					</tr>
